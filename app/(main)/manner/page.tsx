  ...
  return (
    <div className="pt-[env(safe-area-inset-top)]">
      <header className="px-5 pt-6 pb-4">
        <h1 className="text-2xl font-bold text-[var(--text-main)] mb-2">{t('manner.title')}</h1>
        <p className="text-[var(--text-sub)]">{t('manner.subtitle')}</p>
      </header>

      {/* Quick Tips Banner */}
      <div className="px-5 mb-6">
        <div className="p-5 bg-gradient-to-r from-[var(--primary-soft)] to-[var(--accent)]/30 rounded-3xl">
          <p className="text-sm font-medium text-[var(--primary)] mb-1">{t('manner.todayTips')}</p>
          <h3 className="text-lg font-bold text-[var(--text-main)] mb-2">{t('manner.todayExample')}</h3>
      ...
      <section className="px-5 mb-8">
        <SectionHeader title={t('manner.category')} subtitle={t('manner.byScene')} />
      ...
      {/* Popular Tips */}
      <section className="px-5 mb-8">
        <SectionHeader title={t('manner.popular')} subtitle={t('manner.popularSub')} />
      ...
      <section className="px-5 mb-8">
        <div className="p-5 bg-gray-50 rounded-3xl text-center">
          <h3 className="font-semibold text-[var(--text-main)] mb-2">{t('manner.addToPlan')}</h3>
