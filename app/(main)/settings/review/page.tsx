  ...
  if (submitted) {
    return (
      <div className="pt-[env(safe-area-inset-top)] min-h-[80vh] flex flex-col items-center justify-center px-8 text-center">
        ...
        <h1 className="text-xl font-bold text-[var(--text-main)] mb-2">ありがとうございます！</h1>
        <p className="text-sm text-[var(--text-sub)] mb-8">
          いただいたご意見は、より良いTABITOづくりに活かします。
        </p>
        <button
  ...
  return (
    <div className="pt-[env(safe-area-inset-top)]">
      <header className="px-5 pt-6 pb-4">
        ...
        <h1 className="text-2xl font-bold text-[var(--text-main)]">アプリを評価する</h1>
        <p className="text-sm text-[var(--text-sub)] mt-1">TABITOの使い心地はいかがですか？</p>
      </header>
      ...
      <div className="px-5 space-y-6 pb-8">
        <div className="bg-white rounded-2xl shadow-sm p-6 flex flex-col items-center">
          ...
          <p className="text-sm text-[var(--text-sub)] h-5">
            {rating > 0 && ['', '残念でした', 'もう少し', 'まずまず', '良い', '最高です！'][rating]}
          </p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-sm p-4">
          ...
          <textarea
            ...
            rows={4}
            placeholder="改善してほしい点や、気に入っている点を教えてください"
